                            ...
                            <table>
                                <tbody>
                                    ...
                                    @if (count($cartItems) === 0)
                                        <tr class="d-flex" >
                                            <td class="wsus__pro_icon" rowspan="2" style="width:100%">  Cart is empty!  </td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
...
<script>
    $(document).ready(function(){
        ...
        $('.product-increment').on('click', function(){
            // increment düyməsi kliklənəndə onun siblings elementini yəni bir üstündə olan .product-qty class adlı elementi əldə edirik.            
