                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-control sub-category" name="sub_category">
                                        <option value="">Select</option>
                                        {{--  Jquery istifadə edərək, Kateqoriyalar ilə uyğun gələn Sub kateqoriyaları bura əlavə edirik --}}
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-control child-category" name="child_category">
                                        <option value="">Select</option>
                                        {{--  Jquery istifadə edərək, Sub Kateqoriyalar ilə uyğun gələn Child kateqoriyaları bura əlavə edirik --}}
                                    </select>
                                </div>
                            </div>
                        </div>
